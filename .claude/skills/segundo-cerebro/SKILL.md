...
| `CAMPO-FALTANDO` | campo do template ausente **e** sem marcador `PENDENTE:` — incompleta e sinalizada é o estado sancionado; incompleta e calada, não |
